          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={(e) => handleTraditionalIRAChange({ amount: parseFloat(e.target.value) })}
        ...
        <div>
          ...
          <div className="mt-1 relative rounded-md shadow-sm">
            ...
            <input
              ...
              onChange={(e) => handleRothIRAChange({ amount: parseFloat(e.target.value) })}
              className="block w-full rounded-md border-gray-300 pl-7 focus:border-blue-500 focus:ring-blue-500"
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={(e) => handleForm8606Change({ nondeductibleContributions: parseFloat(e.target.value) })}
                className="block w-full rounded-md border-gray-300 pl-7 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={(e) => handleForm8606Change({ priorYearBasis: parseFloat(e.target.value) })}
                className="block w-full rounded-md border-gray-300 pl-7 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={(e) => handleForm8606Change({ conversionsToRoth: parseFloat(e.target.value) })}
                className="block w-full rounded-md border-gray-300 pl-7 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={(e) => handleForm8606Change({ endOfYearTraditionalIRABalance: parseFloat(e.target.value) })}
                className="block w-full rounded-md border-gray-300 pl-7 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
          </div>
