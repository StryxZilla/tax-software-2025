...
const steps: Array<{ id: WizardStep; label: string; shortLabel?: string; description: string }> = [
  ...
  { id: 'income-dividends',       label: 'Dividend Income',            shortLabel: 'Dividends', description: '1099-DIV from investments' },
  ...
  { id: 'income-1099-nec',        label: '1099-NEC Income',            shortLabel: '1099-NEC',  description: 'Nonemployee compensation' },
  { id: 'income-1099-k',          label: '1099-K Income',              shortLabel: '1099-K',    description: 'Third-party settlement org' },
  { id: 'retirement-accounts',    label: 'Retirement Contributions',  shortLabel: 'Retire.',    description: 'IRA & 401(k) contributions' },
  ...
  { id: 'above-the-line',        label: 'Above-the-Line Deductions', shortLabel: 'Above Line', description: 'HSA, student loan interest, etc.' },
  { id: 'deductions',            label: 'Itemized Deductions',        shortLabel: 'Deduct.',    description: 'Schedule A — mortgage, charity' },
  { id: 'deductions-schedule-1a', label: 'Schedule 1 Attachments',      shortLabel: 'Sched. 1',   description: 'Additional income & deductions' },
